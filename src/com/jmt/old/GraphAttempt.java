...
public class GraphAttempt<E extends Comparable<? super E>>
{
    ...
    public GraphAttempt()
    {
        ...
        processors = new ArrayList<NodeProcessor<E>>();
    }
    ...
    public void topologicalSort()
    {
        ...
        NodeProcessor<E> proc = new NodeProcessor<E>()
        {
            ...
            public void processEarly(GraphAttempt.Node v)
            {
            }

            public void processEdge(GraphAttempt.Node from, GraphAttempt.Node to)
            {
            }

            public void processLate(GraphAttempt.Node v)
            {
                ret += " " + v.data;
            }
...
*/
    ...
    public boolean isCyclic()
    {
        NodeProcessor<E> tester = new NodeProcessor<E>()
        {
            ...
            public void processEdge(GraphAttempt.Node from, GraphAttempt.Node to)
            {
                if (to.getState() == GraphAttempt.Node.DISCOVERED)
                    cyclic = true;
            }
            ...
            public void processLate(GraphAttempt.Node v)
            {
                if (v.delete)
                {
                    ...
                    if (v.neighbors.size() == 2)
                    {
                        ...
                        // a and b
                        GraphAttempt.Node a = (GraphAttempt.Node)v.neighbors.get(0);
                        GraphAttempt.Node b = (GraphAttempt.Node)v.neighbors.get(1);
